...
function CSS2948_preprocess_node(&$vars) {
...
function CSS2948_preprocess_comment(&$vars) {
...
function CSS2948_form_alter(&$form, &$form_state, $form_id) {
...
function CSS2948_breadcrumb($variables) {
